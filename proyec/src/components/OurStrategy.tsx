                ...
                <div className="container py-16 py-md-18">
                    <div className="row gx-lg-8 gx-xl-12 gy-10 mb-8 align-items-center">
                        ...
                        <div className="col-lg-5">
                            ...
                            <h3 className="display-4 mb-5">Wonder how much faster your website can go? Easily check your SEO Score now.</h3>
                ...
                <div className="container py-14 pt-md-17 pb-md-15">
                    ...
                    <div className="row gx-lg-8 gx-xl-12 gy-10 mb-lg-22 mb-xl-24 align-items-center">
                        <div className="col-lg-7">
                            <figure><img className="w-auto" src="./assets/img/illustrations/i6.png" srcSet="./assets/img/illustrations/i6@2x.png 2x" alt="" /></figure>
                        </div>
                        <div className="col-lg-5">
