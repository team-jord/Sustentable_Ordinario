...
export default function FirstSection() {
  return (
    <>
          ...
          <div className="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
            <div className="col-lg-7">
              <figure>
                <img
                  className="w-auto"
                  src="https://sandbox.elemisthemes.com/assets/img/illustrations/3d6.png"
                  alt=""
                />
              </figure>
            </div>
            <div className="col-md-10 offset-md-1 offset-lg-0 col-lg-5 text-center text-lg-start">
              <h1 className="display-1 mb-5 mx-md-n5 mx-lg-0" id="vision">
                Cuide de su salud con nuestra solución
              </h1>
              <h1 className="display-0 mb-3 mx-md-n3 mx-lg-0">
                Empower Health Diary
              </h1>
              <p className="lead fs-lg mb-7">
                Empower es una aplicación creada para favorecer la prevención de
                las enfermedades con mayor incidencia, prevalencia y mortalidad
                en México
              </p>
              <span>
                <a className="btn btn-primary rounded-pill me-2">Unirme</a>
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="wrapper bg-light" id="que_hacemos">
          ...
          <div className="row text-center">
            <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2">
              ...
              <h3 className="display-4 mb-10 px-xl-10">
                Empower es una aplicación para registro y seguimiento del estado
                de tu salud personal.
              </h3>
            </div>
          </div>
              ...
              <div className="col-md-6 col-xl-3">
                <div className="card shadow-lg">
                  <div className="card-body">
                    ...
                    <h4>Amigable</h4>
                    <p className="mb-2">Lenguaje claro e interfaz intuitiva.</p>
              ...
              <div className="col-md-6 col-xl-3">
                <div className="card shadow-lg">
                  <div className="card-body">
                    ...
                    <h4>Prevención</h4>
                    <p className="mb-2">
                      Con nuestros cuestionario de salud, te ayudamos a prevenir
                      y tratar tus enfermedades.
                    </p>
              ...
              <div className="col-md-6 col-xl-3">
                <div className="card shadow-lg">
                  <div className="card-body">
                    ...
                    <h4>Acciones oportunas</h4>
                    <p className="mb-2">
                      Despues de cada cuestionario de salud te damos
                      recomendaciones para tratar o prevenir tu caso.
                    </p>
              ...
              <div className="col-md-6 col-xl-3">
                <div className="card shadow-lg">
                  <div className="card-body">
                    ...
                    <h4>Proteccion de datos</h4>
                    <p className="mb-2">
                      Implementamos las mejores practicas para que los datos de
                      nuestros usuarios esten seguros.
                    </p>
